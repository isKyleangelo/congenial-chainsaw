...
class ProductProvider with ChangeNotifier {
  final List<Product> _products = [
    ...
    Product(
      ...
      description:
          'Bring fresh energy with the HLCK Green Tee. Crafted from comfy cotton and bursting with rich green vibes, it’s the perfect twist to your wardrobe. Exclusively available at HLCK — because unique style deserves a unique home.',
    ),
  ];
